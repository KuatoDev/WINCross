...
object DeviceModels {
  ...
  fun setDeviceInfo(
    ...
    val guideLinks =
        mapOf(
                "vayu" to
                    "https://github.com/woa-vayu/POCOX3Pro-Guides/blob/main/en/installation-selection.md",
                "bhima" to
                    "https://github.com/woa-vayu/POCOX3Pro-Guides/blob/main/en/installation-selection.md",
    ...
    imageView.load(imageUrl) { crossfade(true) }
    ...
    tvPanel.text =
        context.getString(
            R.string.device_info, context.getString(R.string.info_panel_type), Utils.getPanelType())
    tvActiveSlot.text =
        context.getString(
            R.string.device_info,
