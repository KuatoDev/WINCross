...
object UsbHostmodeDownloader {
  ...
  private const val FALLBACK_URL = "https://github.com/Misha803/My-Scripts/releases/download/USB-Host-Mode-Control/USB_Host_Mode_Control_V9.0.exe"
  ...
  fun downloadUsbHostmode(context: Context) {
    ...
    CoroutineScope(Dispatchers.IO).launch {
      ...
      withContext(Dispatchers.Main) {
        ...
        if (success) {
          UtilityHelper.showToast(context, context.getString(R.string.download_successful, usbHostmodePath))
          DialogHelper.showPopupNotifications(context, "USB Host Mode Control downloaded successfully")
