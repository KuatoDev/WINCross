...
object BootAutoflasherDownloader {
  ...
  private const val FALLBACK_URL = "https://github.com/Misha803/My-Scripts/releases/download/boot.img-Auto-Flasher/boot_img_auto-flasher_V1.1.exe"
  ...
  fun downloadBootAutoflasher(context: Context) {
    ...
    CoroutineScope(Dispatchers.IO).launch {
      ...
      withContext(Dispatchers.Main) {
        ...
        if (success) {
          UtilityHelper.showToast(context, context.getString(R.string.download_successful, bootFlasherPath))
