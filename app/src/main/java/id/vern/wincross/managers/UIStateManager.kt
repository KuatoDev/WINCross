...
class UIStateManager(
    ...
    private fun updateQuickbootButton() {
        binding.mainbutton.apply {
            tvSwitchToWindows.text = activity.getString(
                if (activity.isUefiAvailable) R.string.boot_to_windows
                else R.string.uefi_not_found
            )

            tvSwitchToWindows.setTextColor(
                if (activity.isUefiAvailable)
                    tvSwitchToWindows.currentTextColor
                else
                    Color.RED
            )
    ...
    private fun updateSelectUefiButton() {
        ...
        binding.mainbutton.tvSelectUefi.text = if (path != null) {
    ...
    private fun updateWindowsStatus() {
        binding.dashboard.tvWindowsInstalled.text = activity.getString(
    ...
    private fun updateToolbox() {
        binding.mainbutton.apply {
            ...
            tvToolbox.text = if (activity.isWindowsMounted) {
